...
export const subIssueSubWebhook = {
	event: "sub_issues",
	payload: {
		action: "sub_issue_added",
		sub_issue_id: 2843908597,
		sub_issue: {
			url: "https://api.github.com/repos/alikulka/demo-repo/issues/9",
			repository_url: "https://api.github.com/repos/alikulka/demo-repo",
			labels_url:
		...
		sub_issue_repo: {
			...
			deployments_url:
				"https://api.github.com/repos/alikulka/demo-repo/deployments",
			created_at: "2025-01-16T22:39:51Z",
			updated_at: "2025-02-14T19:27:15Z",
			pushed_at: "2025-02-12T22:16:43Z",
			git_url: "git://github.com/alikulka/demo-repo.git",
			ssh_url: "git@github.com:alikulka/demo-repo.git",
			clone_url: "https://github.com/alikulka/demo-repo.git",
			svn_url: "https://github.com/alikulka/demo-repo",
		...
		parent_issue_id: 2854721933,
		parent_issue: {
			url: "https://api.github.com/repos/alikulka/demo-repo/issues/14",
			repository_url: "https://api.github.com/repos/alikulka/demo-repo",
			labels_url:
				"https://api.github.com/repos/alikulka/demo-repo/issues/14/labels{/name}",
			comments_url:
				"https://api.github.com/repos/alikulka/demo-repo/issues/14/comments",
			events_url:
				"https://api.github.com/repos/alikulka/demo-repo/issues/14/events",
			html_url: "https://github.com/alikulka/demo-repo/issues/14",
			id: 2854721933,
			node_id: "I_kwDONrZruc6qJ5mN",
			number: 14,
			title: "dude what does this mean",
			user: {
				login: "lehmanmj",
				id: 192139820,
				node_id: "U_kgDOC3PSLA",
			...
			milestone: null,
			comments: 0,
			created_at: "2025-02-14T21:22:22Z",
			updated_at: "2025-02-14T21:22:22Z",
			closed_at: null,
			author_association: "COLLABORATOR",
			sub_issues_summary: { total: 1, completed: 0, percent_completed: 0 },
			active_lock_reason: null,
			body: "### sub issue aaaaaaaaaaaaaaaaaaaaa### \ns**s**_s_ \n\n> u\n`b`\n\n\n[i](google.com)\n\n- s\n- s\n\n1. u\n2. e\n\n- [sub ]\n- @lehmanmj \n- #13 \n- Duplicate of #12 \n- ISSUE ",
			reactions: {
				url: "https://api.github.com/repos/alikulka/demo-repo/issues/14/reactions",
				total_count: 0,
				"+1": 0,
				"-1": 0,
				laugh: 0,
			...
			timeline_url:
				"https://api.github.com/repos/alikulka/demo-repo/issues/14/timeline",
			performed_via_github_app: null,
			state_reason: null,
		},
		repository: {
...
export const subIssueParentWebhook = {
	event: "sub_issues",
	payload: {
...
export const DiscussionAnswerCommentWebhook = {
	event: "discussion_comment",
	payload: {
		action: "created",
		comment: {
			id: 12240481,
			node_id: "DC_kwDOImv4N84AusZh",
			html_url:
				"https://github.com/awslabs/aws-github-test/discussions/50#discussioncomment-12240481",
			parent_id: null,
			child_comment_count: 0,
			repository_url: "awslabs/aws-github-test",
			discussion_id: 5881935,
			author_association: "COLLABORATOR",
			user: {
				login: "lehmanmj",
				id: 192139820,
			...
			created_at: "2025-02-18T18:18:23Z",
			updated_at: "2025-02-18T18:18:24Z",
			body: "test comment!",
			reactions: {
				url: "https://api.github.com/repos/awslabs/aws-github-test/discussions/comments/12240481/reactions",
				total_count: 0,
				"+1": 0,
				"-1": 0,
				laugh: 0,
		...
		discussion: {
			...
			answer_chosen_at: null,
			answer_chosen_by: null,
			html_url: "https://github.com/awslabs/aws-github-test/discussions/50",
			id: 5881935,
			node_id: "D_kwDOImv4N84AWcBP",
			number: 50,
			title: "08",
			user: {
				login: "khushail",
			...
			locked: false,
			comments: 1,
			created_at: "2023-11-23T01:25:07Z",
			updated_at: "2025-02-18T18:18:23Z",
			author_association: "CONTRIBUTOR",
			active_lock_reason: null,
			body: "08",
			reactions: {
				url: "https://api.github.com/repos/awslabs/aws-github-test/discussions/50/reactions",
				total_count: 0,
				"+1": 0,
				"-1": 0,
				laugh: 0,
			...
			timeline_url:
				"https://api.github.com/repos/awslabs/aws-github-test/discussions/50/timeline",
		},
		repository: {
			id: 577501239,
			node_id: "R_kgDOImv4Nw",
...
export const DiscussionAnsweredWebhook2 = {
	event: "discussion",
	payload: {
		action: "answered",
		discussion: {
			...
			answer_html_url:
				"https://github.com/awslabs/aws-github-test/discussions/50#discussioncomment-12240481",
			answer_chosen_at: "2025-02-18T10:20:26.000-08:00",
			answer_chosen_by: {
				login: "lehmanmj",
				id: 192139820,
				node_id: "U_kgDOC3PSLA",
			...
			comments: 1,
			created_at: "2023-11-23T01:25:07Z",
			updated_at: "2025-02-18T18:20:26Z",
			author_association: "CONTRIBUTOR",
			active_lock_reason: null,
			body: "08",
			reactions: {
